...
const Receipt = () => {
    ...
    const { data: receiptData, isLoading } = useQuery({
        queryKey: ["data-epin-receipt", txnResult?.reference],
        queryFn: () => getDataEpinReceipt(txnResult?.reference as string),
    ...
    return (
        <section className="w-full max-w-[400px] mx-auto pb-8 pt-5 px-4">
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="text-[#667085] mt-2 mb-6">You have successfully generated {pins.length} data pin(s).</p>
            </div>
