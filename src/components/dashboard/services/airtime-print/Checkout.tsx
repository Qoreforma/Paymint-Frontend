...
import { buyAirtimeEpin } from "@/lib/api/dashboard-apis/servicesApis";
        ...
        <section className="w-full max-w-[360px] mx-auto pb-5">
            ...
            <div className="mt-14 md:mt-8 bg-white border border-[#F0F2F5] rounded-xl p-5 shadow-sm">
                <div className="flex flex-col items-center justify-center mb-6">
                    ...
                    <h2 className="text-3xl font-bold text-[#101828] mt-1">₦{((denomination || 0) * quantity).toLocaleString()}</h2>
                </div>

                <div className="space-y-4">
                    <div className="flex justify-between items-center text-sm">
                        <span className="text-[#667085]">Network</span>
                        <span className="font-medium text-[#344054] capitalize">{network}</span>
                    </div>
                    <div className="flex justify-between items-center text-sm">
                        <span className="text-[#667085]">Denomination</span>
                        <span className="font-medium text-[#344054]">₦{denomination}</span>
                    </div>
                    <div className="flex justify-between items-center text-sm">
